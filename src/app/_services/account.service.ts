...
export class AccountService {
    ...
    getAllBooks(search: string) {
          return this.http.get<any>(`${environment.apiUrl}/list-books?search=${search}`); 
    }

    getAuthorBooks(id: string) {
        return this.http.get<any>(`${environment.apiUrl}/authors/${id}/books`);
    }

    createAutherBook(id: string, bookdetails: any) {
        return this.http.post(`${environment.apiUrl}/authors/${id}/books`, bookdetails);
    }
